              ...
              <div className="space-y-12 mb-16">
                <div className="max-w-5xl mx-auto">
                  ...
                  <div className="prose prose-lg max-w-none">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      公司办公场地1000平方米，设置了五部一室，其中综合业务部下设留个部门，六个部门中的艺术品部专门根据其特殊性，设立了库房。各部门分工合作，密切配合，共同完成拍卖业务。在公司领导及公司项目部的坚强支持下，经过多年的工作实践和稳步发展，公司在资质、业务等方面都取得了较大的突破。在2011年获得合同信用A级证书，但这并不是我们的终点，公司在接下来的13年获得合同信用AA级证书，在2014年至2015年持续保持,并且获得上海市守合同重信用企业证书。2020年度以来持续获得合同信用AAA级证书，并且为守合同重信用企业。同时也不断的完善提高自己，在2013年的6月向慈善基金会捐赠《山高水长》国画用于慈善事业，支持慈善事业。在2014年，公司通过认真踏实并合理的规章制度在2014加入中国拍卖行业协会会员并且在2017年的年末我司被评为"上海市拍卖企业信用资质等级"4A级拍卖企业。不仅如此，我公司荣获2015年度信息统计工作先进单位，在之后公司又被评为2015-2016年度"上海市公物罚没物资拍卖企业"。同时，我司也适应新形势，勇于开拓新的拍卖模式，互联网+的拍卖模式已在我司充分运用。每场预展、拍卖会全程录像，每个拍品都有照片和文字资料，通过公司网络和二维码即可搜索、查询和咨询，并且拥有专业的拍卖易胜网、微信公众号，微博，腾讯QQ，企业邮箱，指定报刊等信息发布平台，每年荣获上海市拍卖行业协会颁发的"创新进步奖"。之后我司于2017年也加入了上海联合产权交易所拍卖会员。
                    </p>
                    <p className="text-muted-foreground leading-relaxed">
                      我司紧紧围绕「金诚致远 ·
